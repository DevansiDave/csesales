            ...
            <div class="card shadow">
                <div class="card-header border-0">
                    <div class="row align-items-center">
                        <div class="col-8">
                            <h3 class="mb-0">Create Services</h3>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-body">
                    <form action="{{ route('Services.store') }}" method="post" enctype="multipart/form-data" >
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="service_name" name="service_name" class="form-control" value="{{old('service_name')}}" placeholder="Enter services name">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" id="block_of_hours" name="block_of_hours" class="form-control" value="{{old('block_of_hours')}}" placeholder="Enter block of hours">
                        </div>
